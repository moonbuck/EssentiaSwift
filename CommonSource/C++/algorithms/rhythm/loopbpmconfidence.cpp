...
"\n"
"References:\n"
"  [1] Font, F., & Serra, X. (2016). Tempo Estimation for Music Loops and a Simple Confidence Measure. Proceedings of the International Society for Music Information Retrieval Conference (ISMIR).\n\n");
...
void LoopBpmConfidence::compute() {
  ...
  if (bpmEstimate == 0){
    ...
    int duration_samples = (int)signal.size();
