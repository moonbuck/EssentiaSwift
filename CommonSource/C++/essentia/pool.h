...
class Pool {
 ...
 public:
   ...
   * the Pool.
   * @param ns the descriptor name to remove
   */
   ...
   * @param name name of the descriptor you wish to check for
...
inline void Pool::append(const std::string& name, const std::vector<type>& values) {  \
  {                                                                                   \
    ...
    if (result != _pool##tname.end()) {                                               \
      ...
      v.resize(vsize + (int)values.size());                                           \
      fastcopy(&v[vsize], &values[0], (int)values.size());                            \
      return;                                                                         \
    }                                                                                 \
  }                                                                                   \
                                                                                      \
