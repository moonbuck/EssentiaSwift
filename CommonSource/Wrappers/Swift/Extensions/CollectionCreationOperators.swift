...
extension Array {
  ...
  internal static func *(lhs: Array<Element>, rhs: Int) -> Array<Element> {
  ...
  internal func map<T, U>(_ parameter: T, _ transform: (Element, T) throws -> U) rethrows -> [U] {
...
internal func ..<<F:BinaryFloatingPoint>(lhs: F, rhs: F) -> [F] {
