...
"\n"
"References:\n"
"  [1] P. Grosche and M. Müller, \"A mid-level representation for capturing dominant tempo and pulse information in music recordings,\" in International Society for Music Information Retrieval Conference"
"  (ISMIR’09), 2009, pp. 189–194.\n"
"  [2] Tempogram Toolbox (Matlab implementation), http://resources.mpi-inf.mpg.de/MIR/tempogramtoolbox\n");
...
void NoveltyCurve::compute() {
  ...
  int nFrames = (int)frequencyBands.size();
